...
describe('GO1% Dashboard',function(){
    ...
    it('3. Verify appropriate points should be added according to the contribution . - Version1 ',async function(browser){
        browser.expect.element('body > app-root:nth-child(1) > div:nth-child(1) > app-main:nth-child(2) > section:nth-child(1) > main:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > app-my-profile:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > app-my-activity:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(62) > div:nth-child(1) > div:nth-child(3) > div:nth-child(3) > span:nth-child(1)').to.be.visible;
    });
    ...
    it('6. Verify user should see Add a contribution button when no contribution has been added by the user',async function(browser){
        await browser.waitForElementVisible('.nav-item.my-1.cursor-pointer.text-bold.p-2:nth-child(3)',5000);
        await browser.execute(function(){
            document.querySelector('.nav-item.my-1.cursor-pointer.text-bold.p-2:nth-child(3)').click();
        })
