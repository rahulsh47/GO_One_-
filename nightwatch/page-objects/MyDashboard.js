...
module.exports = {
    ...
    elements:{
        ...
        LikeButton: {
            selector: 'div[class="my-dashboard mt-n4"] div:nth-child(1) div:nth-child(1) div:nth-child(2) a:nth-child(1) span:nth-child(1)'
        },
        SeeAll: {
            selector: '.btn.px-3.py-1.all-btn.border-button'
        },
        Comment: {
            selector: 'div[class="my-dashboard mt-n4"] div:nth-child(1) div:nth-child(1) div:nth-child(2) a:nth-child(3) span:nth-child(2)'
        },
